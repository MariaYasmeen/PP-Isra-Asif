  ...
  return (
    <ClientPageWrapper>
      ...
      <section className="space-y-6 pb-8 pt-6 mb-0 md:pb-12 md:py-20 lg:py-32 h-screen flex items-center">
        <div 
            style={{marginTop:"25px"}} className="container flex max-w-[64rem] flex-col items-center gap-4 text-center -mt-20">
          <Image
            src={namanImg}
            height={100}
            width={100}
            ...
            alt="Ahmed Raza - Full Stack Developer Portfolio"
            priority
          />
          <AnimatedText
            as="h1"
          ...
          <div className="mt-4 max-w-[42rem] text-center">
            <p className="leading-normal text-muted-foreground text-sm sm:text-base">
              I am a full stack developer with a strong passion for crafting responsive, user-friendly applications. From intuitive front-end interfaces to robust back-end systems, I enjoy building complete web solutions.
            </p>
          </div>
          ...
          <div className="flex flex-col mt-10 items-center justify-center sm:flex-row sm:space-x-4 gap-3">
            <AnimatedText delay={0.6}>
              <Link
                ...
                aria-label="View Ahmed Raza's GitHub profile"
              >
