export const siteConfig = {
  name: "Ahmed Raza | Developer Portfolio",
  authorName: "Ahmed Raza",
  username: "ahmedraza",
  description:
    "Ahmed Raza's portfolio - A modern, responsive Next.js portfolio for developers. This open-source template can be customized to showcase your own skills, projects, and professional experience.",
  url: "https://nbarkiya.xyz",
  links: {
    twitter: "https://x.com/ahmedraza",
